...
# Create .bashrc file with desired content
cat > ~/.bashrc <<EOF
### EXPORT ###
export EDITOR='nano'
export VISUAL='nano'
...
if [[ ${EUID} == 0 ]]; then
    PS1='\[\033[48;2;255;85;85;38;2;255;255;255m\] # \[\033[48;2;255;165;0;38;2;255;85;85m\]\[\033[48;2;255;165;0;38;2;0;0;0m\] \h \[\033[48;2;83;85;85;38;2;255;165;0m\]\[\033[48;2;83;85;85;38;2;255;255;255m\] \w \[\033[49;38;2;83;85;85m\]\[\033[00m\] '
else
    PS1='\[\033[48;2;50;150;255;38;2;255;255;255m\] $ \[\033[48;2;0;135;175;38;2;50;150;255m\]\[\033[48;2;0;135;175;38;2;255;255;255m\] \u@\h \[\033[48;2;83;85;85;38;2;0;135;175m\]\[\033[48;2;83;85;85;38;2;255;255;255m\] \w \[\033[49;38;2;83;85;85m\]\[\033[00m\] '
fi
...
# Press Alt+Shift+T to open terminal
xcape -e 'Alt_Shift_T=Control_L|Shift_L|Alt_L|T'

# Ask for password once per login
xsecurelock --default_cmd sh -c \
    "while true; do gnome-screensaver-command -a; sleep 1; done" \
    --notify_cmd sh -c \
    "dbus-send --print-reply --dest=org.gnome.ScreenSaver \
...
# Reverting to default find command
unalias find
...
# Ensure the .bashrc file has execute permissions
chmod +x ~/.bashrc
...
# Append additional lines if needed
append_lines=(
    "# Additional aliases"
    'alias new_alias="command"'
)

if [ -n "$(declare -p append_lines 2>/dev/null)" ]; then
